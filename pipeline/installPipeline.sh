...
export REPO=https://github.com/sandepal/mq-cicd.git
export BRANCH=main
...
#cat $SCRIPT_DIR/cicd-pipeline-ace.yaml_template |
#       sed "s#{{REPO}}#$REPO#g;" |
#       sed "s#{{NAMESPACE}}#$TARGET_NAMESPACE#g;" |
#       sed "s#{{BRANCH}}#$BRANCH#g;" |
#       sed "s#{{QMGR_NAME_1}}#$QMGR_NAME_1#g;" |
#       sed "s#{{QMGR_NAME_2}}#$QMGR_NAME_2#g;" > $SCRIPT_DIR/cicd-pipeline-ace.yaml
#
#oc apply -f $SCRIPT_DIR/cicd-pipeline-ace.yaml
...
echo "STARTED OF IBM MQ INSTANCES"